      ...
      <div class="relative -mx-4 flex items-center justify-between">
        ...
        <div class="flex w-full items-center justify-between px-4">
          ...
          <div class="hidden justify-end pr-16 sm:flex lg:pr-0">
            ...
            <a href="signup.html"
              class="signUpBtn rounded-md bg-primary bg-opacity-20 py-2 px-6 text-base font-medium text-white duration-300 ease-in-out hover:bg-blue-dark">
              Sign Up
            </a>
          </div>
        </div>
      ...
      <div class="-mx-4 flex flex-wrap items-center">
        <div class="w-full px-4">
          <div class="text-center">
            <h1 class="mb-4 text-3xl font-bold text-dark sm:text-4xl md:text-[40px] md:leading-[1.2]">Sign In Page</h1>
      ...
      <div class="-mx-4 flex flex-wrap">
        <div class="w-full px-4">
          <div
            ...
            <a href="javascript:void(0)" class="mb-2 inline-block text-base text-dark hover:text-primary">
              Forget Password?
            </a>
